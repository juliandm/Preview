...
export const makeSelectAttributePairs = () => createSelector(selectExplorer,(substate) => substate.topics.map(topic=>topic.attributePairs)); 
...
export const makeSelectLoading =()=> createSelector(selectExplorer,(state)=>{return state.topics.map(t=>t.loading).some(t=>t)});
